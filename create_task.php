...
if(empty($title)AND strlen($title)<8){

    echo'Goal name denied';
...
$sql = "INSERT INTO tasks (user_id, title, description, due_date, status) VALUES ('$user_id', '$title', '$description', '$due_date', '$status')";
